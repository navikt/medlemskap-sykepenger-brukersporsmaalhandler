...
enum class RegelId(val identifikator: String, val avklaring: String, val neiBegrunnelse: String = "", val jaBegrunnelse: String = "", val uavklartBegrunnelse: String = "") {
    ...
    SP6321("Er oppholdet ferie, er varigheten mindre enn 30 dager, og er oppholdet avsluttet for mer enn 30 dager siden?","Er oppholdet ferie, er varigheten mindre enn 30 dager, og er oppholdet avsluttet for mer enn 30 dager siden?","Opphold ikke ferie, eller mer enn 30 dager, eller mindre enn 30 dager siden","Oppholdet er ferie på mindre enn 30 dager, og det er mer enn 30 dager siden","Opphold ikke ferie, eller mer enn 30 dager, eller mindre enn 30 dager siden"),
